...
import UserLocation from './components/DisplayWeather';
...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(position => {
        ...
        //Weather Api call
        Axios.get(`http://api.weatherstack.com/current?access_key=88b43ed3bdef64f0f660b81a5dc05365&query=${this.state.userPosition.latitude},${this.state.userPosition.longitude}`).then(res => {
  ...
  changeLocation = (e) => {
    ...
    Axios.get(`http://api.weatherstack.com/current?access_key=88b43ed3bdef64f0f660b81a5dc05365&query=${this.state.regionInput}`).then(res => {
